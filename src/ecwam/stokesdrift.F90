...
!
!                       OUTPUT: 
!                            *USTOKES*   - U-COMPONENT STOKES DRIFT AT THE SURFACE
!                            *VSTOKES*   - V-COMPONENT STOKES DRIFT AT THE SURFACE
!
!     METHOD.
!     -------
!              DETERMINE U- AND V-COMPONENT OF SURFACE STOKES DRIFT FOLLOWING
