...
IF (IREFRA == 2 .OR. IREFRA == 3) THEN
  ...
  ENDDO
  WRITE(IU06,*) ''
  WRITE(IU06,*) ' THE MAXIMUM CURRENT SPEED ALLOWED IS ',ZCURMAX
  WRITE(IU06,*) ' THE LOWEST FREQUENCY INDEX FOR WHICH PROPAGATION DIRECTION MIGHT REVERSED IS ',MRVLCUR
  WRITE(IU06,*) ''
ENDIF
