...
!
      ...
      SUBROUTINE DMEANSQS_LF(XKMSS, KIJS, KIJL, F, WAVNUM, MSSXX, MSSYY, MSSXY)

! ----------------------------------------------------------------------

!**** *DMEANSQS_LF* - COMPUTATION OF DIRECTIONAL MEAN SQUARE SLOPE UP TO WAVE
!                  NUMBER XKMSS.
...
!       *CALL* *DMEANSQS_LF (XKMSS, KIJS, KIJL, F, WAVNUM, MSSXX, MSSYY, MSSXY)*
...
! ----------------------------------------------------------------------
      ...
      IF (LHOOK) CALL DR_HOOK('DMEANSQS_LF',0,ZHOOK_HANDLE)
...
!     CROSS TERM
      ...
      IF (LHOOK) CALL DR_HOOK('DMEANSQS_LF',1,ZHOOK_HANDLE)

      END SUBROUTINE DMEANSQS_LF
