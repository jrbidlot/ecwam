...
!                         AND ALTIMETER DATA ASSIMILATION WINDOW.
      ...
      REAL(KIND=JWRB) :: PGSEALLEVIATE  !! TUNING COEFFICIENT FOR THE GARDEN SPRINKLER ALLEVIATION SCHEME
...
!      *IGRSPR*    INTEGER   GARDEN SPRINKLER EFFECT ALLEVIATION
!                            = 0 NO ALLEVIATION 
!                            = 1 FIRST ORDER ALLEVIATION SCHEME 
!                            = 2 SECOND ORDER ALLEVIATION SCHEME 
...
!                            ABSOLUTE TERMS.
!      *LADDGUST*  LOGICAL   ADD WIND GUST CORRECTION TO MEAN WIND
...
!                            COMPUTED.
!      *LLUNSETICE* LOGICAL  CONTROLS WHETHER UNSETICE IS CALLED IN *INITMDL*
