...
!     *LRALTASCII*   LOGICAL CONTROLS WHETHER RADAR ALTIMETER OBS INPUT IS IN ASCII TEXT RATHER THAN BINARY WHEN NOT USING ODB
!     *LRALTAVERAGE* LOGICAL CONTROLS WHETHER RADAR ALTIMETER OBS INPUT HAS BEEN AVERAGED ALONG TRACK OR NOT 
