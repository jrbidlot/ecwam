...
!      *MRVLCUR*   INTEGER   FREQUENCY INDEX OF THE LOWEST FREQUENCY FOR WHICH ONE COULD EXPECT
!                            RESERSAL OF PROPAGATION DIRECTION DUW TO THE CURRENTS IN PROPAGS2
