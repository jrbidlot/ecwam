...
!
      ...
      SUBROUTINE WVWAMINIT1(LDWCOUIFS, LDWCOU2W, LDWCOURNW, LDWCOUHMF, LDWFLUX, LDWCOUSPRAY, LDWWCF, LFDBOPIFS)
...
! ----------------------------------------------------------------------
      ...
      USE YOWCOUP  , ONLY : LWCOU    ,LWCOU2W  ,LWCOURNW, LWCOUHMF, LWFLUX, LWCOUSPRAY, LWWCF
...
! ----------------------------------------------------------------------
      ...
      LOGICAL, INTENT(IN) :: LDWCOUIFS, LDWCOU2W, LDWCOURNW, LDWCOUHMF, LDWFLUX, LDWCOUSPRAY, LDWWCF, LFDBOPIFS
