...
!*     ** *ICE* ICE POINTS
      ...
      REAL(KIND=JWRB), PARAMETER   :: PTHC1=0.2_JWRB
      REAL(KIND=JWRB), PARAMETER   :: PTHC2=0.4_JWRB

      REAL(KIND=JWRB), PARAMETER   :: ZALPFACB=0.15_JWRB
      REAL(KIND=JWRB), PARAMETER   :: ZALPFACX=1.0_JWRB
      REAL(KIND=JWRB), PARAMETER   :: ZALPWRS=1.0_JWRB
      REAL(KIND=JWRB), PARAMETER   :: ZIBRW_THRSH= 0.5_JWRB
...
!     --------     ----      -------
!     IPARAMCI     INTEGER   GRIB PARAMETER VALUE OF SEA ICE FRACTION OR SST. !!!! obsolete !!!!
...
!     PTHC1, PTHC2 REAL      CONSTANTS FOR PARAMETRISATION OF SEA ICE THICKNESS IN TERMS OF SEA ICE COVER:
...
!     LWAMRSETCI   LOGICAL   SET TO TRUE IF SHW and PERIOD THAT ARE EXCHANGED WITH THE OCEAN
