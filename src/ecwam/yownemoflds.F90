...
!     --------     ----      -------
!     LNEMOCITHICK LOGICAL   SET TO TRUE IF SEA ICE THICKNESS IS AVAILABLE FROM NEMO 
!     LNEMOICEREST LOGICAL   SET TO TRUE IF SEA ICE  THICKNESS IS NOT POTENTIALLY RESCALED WITH COVER (see *MICEP*)
!---------------------------------------------------------------------
