...
!$loki inline
!!!!!debile CALL STOKESDRIFT(KIJS, KIJL, FL1, STOKFAC, WSWAVE, WDWAVE, CICOVER, USTOKES, VSTOKES)
CALL STKDRFWD(KIJS, KIJL, FL1, 1.0_JWRB, WAVNUM, STOKFAC, DEPTH, WSWAVE, WDWAVE, CICOVER, USTOKES, VSTOKES)
