...
!                 MINIMUM CHARNOCK CONSTANT FOR NO WIND/LOW WIND AND WIND SPEED THRESHOLD WHEN THAt STOPS
      REAL(KIND=JWRB), PARAMETER :: ALPHAMIN_NW=0.011_JWRB
      REAL(KIND=JWRB), PARAMETER :: U10THRS_NW=10._JWRB
!     MAXIMUM CHARNOCK
...
!     Negative wind input, ARDHUIN et al. 2010:
      REAL(KIND=JWRB), PARAMETER :: SWELLF = 0.65_JWRB ! controls the turbulent swell dissipation
      ...
      REAL(KIND=JWRB), PARAMETER :: SWELLF5 = 0.7_JWRB ! controls the viscous swell dissipation
