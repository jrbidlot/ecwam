...
!      *LWFLUX*    LOGICAL   IF TRUE FLUXES FOR OCEAN MODEL AND A FEW INTEGRATED PARAMETERS ARE PRODUCED FOR THE IFS.
!      *LWCOUSPRAY*LOGICAL   IF TRUE FLUXES FOR OCEAN MODEL AND A FEW INTEGRATED PARAMETERS ARE PRODUCED FOR THE IFS.
!      *LWWCF*     LOGICAL   IF TRUE WHITECAP FRACTION FIELD(s) NEEDED IN THE IFS ARE PRODUCED.
