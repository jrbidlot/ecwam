...
!*    ** *COUT*  OUTPUT POINTS INDICES AND FLAGS.
      ...
      INTEGER(KIND=JWIM), PARAMETER :: NTSTK=10 
      INTEGER(KIND=JWIM), PARAMETER :: JPPFLAG=77+3*NTRAIN+2*NTSTK+5 !!!! change also in scripts: wave_setgflag
      ...
      INTEGER(KIND=JWIM) :: IRWDIR,IRCD,IRTAUW,IRU10,IRHS,IRTP,IRT1,IRPHIAW,IRPHIOC,IRTAUOC,IRMSS
...
!      *NTSTK*     INTEGER   NUMBER OF U and V STOKES DRIFT FIELDS THAT ARE COMPUTED AT DEPTH 
...
!      *DPTHSTK    REAL      DEPTHS FOR THE STOKES DRIFT WITH DEPTH. 
...
!      *IRTAUW*    INTEGER   INDEX IN IPFGTBL OF NORMALISED TAUW 
